...
let dummyRecentMessages: [RecentMessage] = [
    ...
    RecentMessage(lastMsg: "That sounds like an exciting game!", lastMsgTime: "10:30 AM", pendingMsg: "1", userName: "Tom", userImage: "https://firebasestorage.googleapis.com/v0/b/ai-travel-manager.appspot.com/o/Rectangle%2011.png?alt=media&token=79758dc1-e808-425a-bb8a-0d3e0861661e", allMessage: dummyMessages),
